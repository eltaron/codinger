...
<?php $__env->startSection('content'); ?>
    ...
    <section class="main-home-rapper">
        <?php if(!empty($heroSectionData)): ?>
            ...
            <section>
                <div class="slider-container <?php echo e($heroSection == '2' ? 'slider-hero-section2' : ''); ?> lg:pt-64! md:pt-48! pt-12! relative px-6!"
                    style="background-image: url('<?php echo $heroSectionData['hero_vector']; ?>'); background-size: cover; background-position: bottom; background-repeat: no-repeat;">
...
<div class="logos-container absolute lg:bottom-[-250px] sm:bottom-[-200px] bottom-[-250px] inset-x-0">
    <div class="logos-track">
        ...
        <?php $__currentLoopData = array_merge($logos, $logos); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $logo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="logo-item">
    ...
    @media (max-width: 768px) {
        .logos-container {
            --logo-height: 80px;
                                ...
                                <div class=" hidden! ">
                                    <?php if(!empty($heroSectionData['has_lottie']) and $heroSectionData['has_lottie'] == '1'): ?>
                                        <lottie-player src="<?php echo $heroSectionData['hero_vector']; ?>" background="transparent" speed="1"
                                            class="w-full" loop autoplay></lottie-player>
                                    <?php else: ?>
                                        <img loading="lazy" src="<?php echo $heroSectionData['hero_vector']; ?>" alt="<?php echo $heroSectionData['title']; ?>"
                        ...
                        <?php else: ?>
                            <div class="text-center pt-0 pb-12 md:pb-20">
                                <?php if(empty($heroSectionData['is_video_background'])): ?>
                                    <img loading="lazy" src="<?php echo e($heroSectionData['hero_background']); ?>" alt="Background Image"
                                        class="blurred-img">
                                <?php endif; ?>
                                <div class="pt-12 md:pt-[6.25rem]">
                                    ...
                                    <div class="flex flex-col items-center justify-center text-center">
                                        <div class="w-full md:w-9/12 lg:w-7/12">
                                            <p class="mt-6 md:mt-8 text-[1rem] md:text-[1.125rem]"><?php echo $heroSectionData['description']; ?>
                                            ...
                                            <form action="/search" method="get" class="inline-flex mt-6 md:mt-8 w-full">
                                                <div
                                                    ...
                                                    <input type="text" name="search"
                                                        ...
                                                        placeholder="<?php echo trans('home.slider_search_placeholder'); ?>">
                                                    <button type="submit"
                                                        class="bg-blue-500 text-white rounded-full px-6 py-2 hover:bg-blue-600 transition-colors duration-300"><?php echo trans('home.find'); ?></button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="avatar bg-gray200">
                                                                    <img loading="lazy" src="<?php echo e($feature->webinar->teacher->getAvatar()); ?>"
                                                                        class="img-cover"
                                        ...
                                        <a href="<?php echo e($trend->category->getUrl()); ?>">
                                            <div class="trending-card d-flex flex-column align-items-center w-100">
                                                <div class="trending-image d-flex align-items-center justify-content-center w-100"
                                                    ...
                                                    <div class="icon mb-3">
                                                        <img loading="lazy" src="<?php echo e($trend->getIcon()); ?>" width="10" loading="lazy"
                        ...
                        <?php $__currentLoopData = $advertisingBanners1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-<?php echo e($banner1->size); ?>">
                                <a href="<?php echo e($banner1->link); ?>">
                                    <img loading="lazy" src="<?php echo e($banner1->image); ?>" class="img-cover rounded-sm" loading="lazy"
              ...
              <?php $__currentLoopData = $subscribes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $subscribe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="swiper-slide">
                  <div
                    ...
                    <!-- Button -->
                    <a href="/subscribe_details/<?php echo e($subscribe->id); ?>"
...
<script>
  ...
  transform: none !important;   /* stop scaling/shrinking */
    ...
    <?php endif; ?>
                                ...
                                <div class="col-12 col-lg-6 mt-20 mt-lg-0">
                                    <div class="position-relative ">
                                        <img loading="lazy" src="<?php echo e($findInstructorSection['image']); ?>" class="find-instructor-section-hero"
                            ...
                            <div class="row align-items-center">
                                <div class="col-12 col-lg-6">
                                    <div class="position-relative reward-program-section-hero-card">
                                        <img loading="lazy" src="<?php echo e($rewardProgramSection['image']); ?>" class="reward-program-section-hero"
    ...
    <?php endif; ?>
                                ...
                                <div class="col-12 col-lg-6 mt-20 mt-lg-0">
                                    <div class="position-relative ">
                                        <img loading="lazy" src="<?php echo e($becomeInstructorSection['image']); ?>"
                ...
                <!--    <section>
                        <div class="home-sections home-sections-swiper container find-instructor-section position-relative">
                            <div class="row align-items-center">
                                <div class="col-12 col-lg-6 mt-20 mt-lg-0">
                                    <div class="position-relative ">
                                        <img loading="lazy" src="<?php echo e($forumSection['image']); ?>" class="find-instructor-section-hero"
                                            ...
                                            <div class="shadow-effect" style="background: transparent; box-shadow: none;">
                                                <div
                                                    ...
                                                    <div class="instructors-card-avatar">
                                                        <img loading="lazy" src="<?php echo e($instructor->getAvatar(108)); ?>"
    ...
    <div class="col-<?php echo e($banner2->size); ?>">
                                    <a href="<?php echo e($banner2->link); ?>">
                                        <img loading="lazy" src="<?php echo e($banner2->image); ?>" class="img-cover rounded-sm"
    ...
    <div class="swiper-slide">
                                                <div
                                                    ...
                                                    <div class="home-organizations-avatar">
                                                        <img loading="lazy" src="<?php echo e($organization->getAvatar(120)); ?>"
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <section class="mt-24! mb-24!" style="" id="projects">
            ...
            margin-top: 0px;">
              ...
              style=" color:#112058;"><?php echo e(trans('home.projects')); ?></h2>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
                        <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div
                                ...
                                <img loading="lazy" src="<?php echo e($item['icon']); ?>" alt="<?php echo e($item['text']); ?>" loading="lazy"
            ...
            <div class="container mx-auto px-4">
                <div class="flex flex-col lg:flex-row gap-10! lg:gap-32! items-start relative">
                    ...
                    <div class="flex-1! flex flex-col  items-center px-12! ">
                        ...
                        <h1 class="mb-6! text-3xl font-bold text-primary text-center"><?php echo e(trans('home.vision_title')); ?>

                        </h1>
                        <p class="mb-6! text-lg text-gray-800! leading-relaxed! text-center">
                            <?php echo e(trans('home.vision_desc')); ?></p>
                    ...
                    <div class="flex-1! flex flex-col items-center px-12!  justify-start">
                        <img loading="lazy" src="store/1/missionimg.jpg" alt="About Us"
                            class="w-[125px] h-[125px] rounded-lg shadow-lg object-cover mb-12!" loading="lazy">
                        <h1 class="mb-6! text-3xl font-bold text-primary text-center"><?php echo e(trans('home.mission_title')); ?>

                        </h1>
                        <p class="mb-6! text-lg text-gray-800! leading-relaxed! text-center">
                            <?php echo e(trans('home.mission_desc')); ?></p>
                    </div>
                </div>
            </div>
        </section>
...
<section class="lg:block! hidden! mt-24!">
    <div class="container mx-auto! px-4!">
        <h2 class="xl:text-[40px]! lg:text-[34px]! text-[28px]! font-bold! text-center! mb-12! text-[#203574]!">
            <?php echo e(trans('home.benefits_title')); ?>
        ...
        <section class="lg:hidden! mt-16!">
            <div class="container! mx-auto! px-4!">
                <h2 class="xl:text-[40px]! lg:text-[34px]! text-[24px]! font-bold! text-center! mb-12! text-[#203574]!">
                    <?php echo e(trans('home.benefits_title')); ?></h2>
                ...
                <div class="lg:hidden! space-y-8!">
                    ...
                    <div
                        ...
                        <div class="flex! flex-col! md:flex-row! items-center! gap-6! py-6!">
                            <div class="flex-shrink-0!">
                                <img loading="lazy" loading="lazy" src="/store/1/image0.jpg" alt="<?php echo e(trans('home.card1.title')); ?>"
                    ...
                    <div
                        ...
                        <div class="flex! flex-col! md:flex-row! items-center! gap-6! py-6!">
                            <div class="flex-shrink-0!">
                                <img loading="lazy" loading="lazy" src="/store/1/image1.svg" alt="<?php echo e(trans('home.card2.title')); ?>"
                                    class="w-32! h-32! rounded-full! object-cover!">
                            </div>
                            <div class="flex-grow!">
                                <h3
                    ...
                    <div
                        ...
                        <div class="flex! flex-col! md:flex-row! items-center! gap-6! py-6!">
                            <div class="flex-shrink-0!">
                                <img loading="lazy" loading="lazy" src="/store/1/image2.svg" alt="<?php echo e(trans('home.card3.title')); ?>"
                                    class="w-32! h-32! rounded-full! object-cover!">
                            </div>
                            <div class="flex-grow!">
                                <h3
                    ...
                    <div class="relative! overflow-hidden! mt-8! flex! justify-center!">
                        <img loading="lazy" loading="lazy" src="/store/1/newheader.png" alt="<?php echo e(trans('home.card2.title')); ?>"
        ...
        <section class="py-16! mt-16!" id="prize">
            <div class="home-sections container">
                <h2 class="section-title mb-12! text-center xl:text-[40px]! lg:text-[34px]! text-[28px]!">
                    <?php echo e(trans('home.prizes')); ?></h2>
