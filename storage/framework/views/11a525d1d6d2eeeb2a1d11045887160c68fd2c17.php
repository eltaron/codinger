<div class="main-sidebar">
    ...
    <ul class="dropdown-menu">
        ...
        <li
            ...
            <?php endif; ?>
 				<li
                    class="<?php echo e(request()->is(getAdminPanelUrl('/info-form', false)) ? 'active' : ''); ?>">
                    <a class="nav-link" href="<?php echo e(getAdminPanelUrl()); ?>/info-form">
                                                <i class="fas fa-user-clock"></i>
<span><?php echo e(trans('admin/main.info_title')); ?></span>
                    </a>
                </li>
