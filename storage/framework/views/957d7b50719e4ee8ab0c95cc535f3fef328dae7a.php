...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <select name="users[]" multiple="multiple" class="form-control search-user-select2"
                      ...
                      <script>
                      console.log(<?php echo json_encode($userGroups, 15, 512) ?>)
                      </script>
...
<?php /**PATH /home/codinger/htdocs/codinger.online/resources/views/admin/users/groups/tabs/general.blade.php ENDPATH**/ ?>