    ...
    <section class="bg-white">
        ...
        <section class="container mt-45">
            ...
            <div class="row my-30">
                                ...
                                <div class="rounded-sm shadow-xl mt-20 py-25 px-20">
                                    ...
                                    <form action="/carts/coupon/validate" method="Post">
                                        ...
                                        <button type="submit" id="checkCoupon"
                                            class="btn btn-sm btn-primary mt-15"><?php echo e(trans('cart.validate')); ?></button>
                                    </form>
                                </div>
                            </div>
              ...
              <div class="col-12 col-lg-3">
                                <h3 class="section-title mt-45"><?php echo e(trans('cart.voucher_code')); ?></h3>
                                <div class="rounded-sm shadow-xl mt-20 py-25 px-20">
                                    <p class="text-gray font-14"><?php echo e(trans('cart.voucher_code_hint')); ?></p>
                                    <div class="voucher-input mt-40">
                                        <input type="text" id="voucher_code_input" class="form-control mb-3 mt-5"
                                            placeholder="<?php echo e(trans('cart.enter_your_voucher_code_here')); ?>">
                                        <button type="button" id="checkVoucher" class="btn btn-sm btn-primary mt-15">
            ...
            <form action="/payments/payment-request" method="post" class="mt-25 pb-24!">
                <div class="d-flex align-items-center justify-content-between mt-45 mb-50">
                    <span class="text-2xl! font-semibold! text-secondary"><?php echo e(trans('financial.total_amount')); ?>
                ...
                <div class="row">
                            ...
                            <?php if(!$isMultiCurrency or !empty($paymentChannel->currencies) and in_array($userCurrency, $paymentChannel->currencies)): ?>
                                <div class="col-6 col-lg-4 mb-40 charge-account-radio">
                                    ...
                                    <label for="<?php echo e($paymentChannel->title); ?>"
                                        ...
                                        <img src="<?php echo e($paymentChannel->image); ?>" width="120" height="60"
                                            alt="">
                    ...
                    <div class="col-6 col-lg-4 mb-40 charge-account-radio">
                        <input type="radio" <?php if(empty($userCharge) or $total > $userCharge): ?> disabled <?php endif; ?> name="gateway"
                            id="offline" value="credit">
                        <label for="offline"
                            class="rounded-sm p-20 p-lg-45 d-flex flex-column align-items-center justify-content-center">
            ...
            <?php if(!empty($invalidChannels) and empty(getFinancialSettings('hide_disabled_payment_gateways'))): ?>
                <div class="d-flex align-items-center mt-30 rounded-lg border p-15">
                    ...
                    <div class="ml-5">
                        <h4 class="font-14 font-weight-bold text-gray"><?php echo e(trans('update.disabled_payment_gateways')); ?>
