    ...
    <section class="bg-white">
        ...
        <section class="container mt-45">
            ...
            <div class="row my-30">
                                ...
                                <div class="rounded-sm shadow-xl mt-20 py-25 px-20">
                                    ...
                                    <form action="/carts/coupon/validate" method="Post">
                                        ...
                                        <button type="submit" id="checkCoupon"
                                            class="btn btn-sm btn-primary mt-15">{{ trans('cart.validate') }}</button>
                                    </form>
                                </div>
                            </div>
              ...
              <div class="col-12 col-lg-3">
                                <h3 class="section-title mt-45">{{ trans('cart.voucher_code') }}</h3>
                                <div class="rounded-sm shadow-xl mt-20 py-25 px-20">
                                    <p class="text-gray font-14">{{ trans('cart.voucher_code_hint') }}</p>
            ...
            <form action="/payments/payment-request" method="post" class="mt-25 pb-24!">
                <div class="d-flex align-items-center justify-content-between mt-45 mb-50">
                    <span class="text-2xl! font-semibold! text-secondary">{{ trans('financial.total_amount') }}
                ...
                <div class="row">
                            ...
                            @if (!$isMultiCurrency or !empty($paymentChannel->currencies) and in_array($userCurrency, $paymentChannel->currencies))
                                <div class="col-6 col-lg-4 mb-40 charge-account-radio">
                                    ...
                                    <label for="{{ $paymentChannel->title }}"
                                        ...
                                        <img src="{{ $paymentChannel->image }}" width="120" height="60"
                                            alt="">
                    ...
                    <div class="col-6 col-lg-4 mb-40 charge-account-radio">
                        <input type="radio" @if (empty($userCharge) or $total > $userCharge) disabled @endif name="gateway"
